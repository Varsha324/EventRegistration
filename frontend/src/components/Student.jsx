            ...
            <div className="rules">
                ...
                <ul>
                    ...
                    <li>They could view the registered events status . </li>
                     <li>They will also be able to see the approved and rejected events.</li>
                     <li>Kindly register to the events after verifying whether is present in the approved and rejected list</li>
                </ul>
            </div>
